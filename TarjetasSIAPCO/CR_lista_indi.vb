...
Public Class CR_lista_indi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TarjetasSIAPCO.CR_lista_indi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_lista_indi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_lista_indi = New CR_lista_indi()
        rpt.Site = Me.Site
        Return rpt
    End Function
